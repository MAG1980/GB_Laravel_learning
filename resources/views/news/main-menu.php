<ul class="main-menu">
    <li class="main-menu__li"><a class="main-menu__link" href="<?=route('home')?>">Страница приветствия</a></li>
    <li class="main-menu__li"><a class="main-menu__link" href="<?=route('news.all')?>">Список новостей</a></li>
    <li class="main-menu__li"><a class="main-menu__link" href="<?=route('news.category_all')?>">Список
            категорий</a></li>
